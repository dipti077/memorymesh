      ...
      <div className="mb-6">
        <ProfilePhotoUploader
          ...
          onPhotoChange={(photoUrl) => {
            // In a real app, this would update the user's profile photo
      ...
      <div>
        <TouchOptimized>
          <button
            ...
            className="flex items-center space-x-2 w-full bg-red-50 text-red-600 px-4 py-3 rounded-lg hover:bg-red-100 transition-colors"
          >
            <Trash2 size={18} />
